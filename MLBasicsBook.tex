...
average loss achieved by the solution of ERM is referred to as the training error. 
...
\begin{figure}
	\begin{center}
		...
		\end{tikzpicture}
	\end{center}
	\label{fig_valdiation_idea}
	\caption{The idea of validation is to split the datapoints into a training set and a validation set.}
\end{figure}
%\end{document}
