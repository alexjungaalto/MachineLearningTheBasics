...
\begin{algorithm}[htbp]
	...
	\begin{algorithmic}[1]
		...
		\State randomly shuffle the datapoints in $\dataset$
		...
		\State create the validation set $\valset$ by the $\samplesize_v = \samplesize - \samplesize_t$ remaining datapoints, 
